...
public class MainWindow extends JFrame implements PropertyChangeListener {
    ...
    private void $$$setupUI$$$() {
        ...
        mainPanel.add(topPannel, BorderLayout.NORTH);
        ...
        middlePannel.setLayout(new BorderLayout(0, 0));
        mainPanel.add(middlePannel, BorderLayout.CENTER);
        final JScrollPane scrollPane1 = new JScrollPane();
        middlePannel.add(scrollPane1, BorderLayout.CENTER);
        logTextArea = new JTextArea();
        logTextArea.setColumns(0);
        logTextArea.setRows(0);
