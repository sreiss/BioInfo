...
//    Promise<List<Gene>, Throwable, Object> processGenes(List<String> geneIds);
    ListenableFuture<XSSFWorkbook> processGenes(Organism organism, XSSFWorkbook workbook, List<Tuple<String, String>> geneIds, String path, HashMap<String, Sum> organismSums);
}
